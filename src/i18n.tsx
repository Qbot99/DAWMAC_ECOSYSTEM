...
const dict = {
  pl: {
    nav: ["Katalog", "Technologie", "Cennik", "Dlaczego kute", "Kontakt"],
    ...
    cmpTitle: "Kute vs odlewane",
    cmpForged: "Kute",
    cmpCast: "Odlewane",
    cmpNote: "Wytrzymałość przy tej samej masie",
  ...
  en: {
    nav: ["Catalog", "Technologies", "Pricing", "Why forged", "Contact"],
    ctaCat: "View catalog",
    ctaPrice: "Pricing",
    hero1: "FORGED",
    hero2: "WHEELS.",
    ...
    cmpTitle: "Forged vs cast",
    cmpForged: "Forged",
    cmpCast: "Cast",
    cmpNote: "Strength at equal weight",
  ...
  de: {
    nav: ["Katalog", "Technologien", "Preisliste", "Warum geschmiedet", "Kontakt"],
    ...
    cmpTitle: "Geschmiedet vs gegossen",
    cmpForged: "Geschmiedet",
    cmpCast: "Gegossen",
    cmpNote: "Festigkeit bei gleichem Gewicht",
